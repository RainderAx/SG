...
namespace WebApplication1
{
    public partial class MLModel1
    {
        ...
        public class ModelInput
        {
            ...
            public float Personnage_x { get; set; }

            [LoadColumn(1)]
            [ColumnName(@"personnage_y")]
            public float Personnage_y { get; set; }

            [LoadColumn(2)]
            [ColumnName(@"pers2_x")]
            public float Pers2_x { get; set; }

            [LoadColumn(3)]
            [ColumnName(@"pers2_y")]
            public float Pers2_y { get; set; }

            [LoadColumn(4)]
            [ColumnName(@"gojo_x")]
            public float Gojo_x { get; set; }

            [LoadColumn(5)]
            [ColumnName(@"gojo_y")]
            public float Gojo_y { get; set; }

            [LoadColumn(6)]
            [ColumnName(@"gojo_score")]
            public float Gojo_score { get; set; }
        ...
        {
            [ColumnName(@"personnage_x")]
            public uint Personnage_x { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("personnage_x");
            if (labelColumn == null)
            {
                throw new Exception("personnage_x column not found. Make sure the name searched for matches the name in the schema.");
            }
